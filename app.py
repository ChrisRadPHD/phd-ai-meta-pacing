...
app = FastAPI(
    ...
    description="Fetches Meta budgets+spend, computes daily/flight pacing, optional 7-day series and filters.",
    version="1.6.0",
)
...
def pacing(
    ...
    name_filter: Optional[str] = None,       # substring on ad set name
    ...
    if level.lower() != "adset":
        raise HTTPException(status_code=400, detail="Supports level=adset only.")
